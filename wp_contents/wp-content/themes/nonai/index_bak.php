...
<main>
    ...
    <section id="info_box" class="section">
        ...
        <div id="news_box">
        <div class="flex">
            <h2><img src="<?php echo home_url( '/' ); ?>images/ttl_news.png" alt="NEWS" /></h2>
...
?>
            ...
            <div id="news_box">
        <div class="flex">
            <h2><img src="<?php echo home_url( '/' ); ?>images/ttl_awards.png" alt="AWARDS" /></h2>
...
?>
    ...
    <section id="catheter_box" class="section">
        ...
        <div class="flex">
         ...
         <div class="img_box"><img src="<?php echo home_url( '/' ); ?>images/img_catheter.png" alt="カテーテルのイメージ画像" /></div>
...
<ul id="relation_list" class="flex">
<?php
$temp = $wp_query;
$wp_query = null;
$args = array(
...
<li>日本脳神経超音波学会認定検査士2名</li>
    ...
    <section id="message_box" class="section">
        <div class="wrap">
        <div class="detail_box">
            <h2><img src="<?php echo home_url( '/' ); ?>images/ttl_message.png" alt="MESSAGE" /></h2>
            <p class="catch">我々がこの地域の脳卒中・<br class="sp"> 神経救急診療を止めずに担う </p>
            <ul>
...
?>
    ...
    <section id="recruit_box" class="section">
        <div class="wrap">
            ...
            <ul class="flex">
                <li class="btn"><a href="<?php echo home_url( '/' ); ?>recruit/index.html">採用情報を見る</a></li>
